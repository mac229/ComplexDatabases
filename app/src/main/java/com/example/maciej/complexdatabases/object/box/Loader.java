...
import static com.example.maciej.complexdatabases.object.box.ObjectBoxProcessor.SEPARATOR;
    ...
    private Data load() throws IOException {
        ...
        while ((line = uniqueTracks.readLine()) != null) {
            ...
            if (!songsOldIdToIdMap.containsKey(oldSongId)) {
                ...
                Song song = new Song(0, oldSongId, getTitle(splitLine));
        ...
        while ((line = tripletsSample.readLine()) != null) {
            ...
            if (songsOldIdToArtistIdMap.containsKey(oldSongId)) {
                ...
                if (!dateToIdMap.containsKey(format1.format(calendar.getTime()))) {
                    ...
                    Date date = new Date(0, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH));
                ...
                if (!timeToIdMap.containsKey(format2.format(calendar.getTime()))) {
                    ...
                    Time time = new Time(0, calendar.get(Calendar.HOUR), calendar.get(Calendar.MINUTE));
                ...
                if (!usersOldIdToIdMap.containsKey(oldUserId)) {
                    ...
                    User user = new User(0, oldUserId);
                    data.getUsers().add(user);
                    userIdCounter++;
                }

                Playback playback = new Playback(0, songsOldIdToIdMap.get(oldSongId),
